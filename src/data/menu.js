...
function playmateMapProduct(id, mapLabel, tiers, imageIdx, priority) {
  ...
  return {
    ...
    image: `/images/rules/order-${String(imageIdx).padStart(2, '0')}.webp`,
    heroImage: `/images/rules/order-${String(imageIdx).padStart(2, '0')}.webp`,
    heroTitle: mapLabel,
    heroSubtitle: '果壳电竞',
...
export default {
  ...
  merchant: {
    name: '果壳电竞',
    avatar: '/images/merchant-avatar.png',
    followers: 25000
  },
  products: [
    // --- 特色体验单（3 条：仅价格 + 地图/模式不同）---
    {
      ...
      tags: ['特色体验单', '零号大坝', '机密'],
      image: '/images/rules/order-01.webp',
      heroImage: '/images/rules/order-01.webp',
      heroTitle: '零号大坝体验',
      heroSubtitle: '果壳电竞',
      experienceMeta: {
        mapKey: 'zero_dam',
...
下单时请说明本体验单类型，避免与正式护航混淆。
    ...
    },
    {
      ...
      tags: ['特色体验单', '绝密', '监狱除外'],
      image: '/images/rules/order-02.webp',
      heroImage: '/images/rules/order-02.webp',
      heroTitle: '绝密体验（不含监狱）',
      heroSubtitle: '果壳电竞',
      experienceMeta: {
...
价格与累计：98r，双护累计 588 万。
    ...
    },
    {
      ...
      tags: ['特色体验单', '监狱', '体验'],
      image: '/images/rules/order-03.webp',
      heroImage: '/images/rules/order-03.webp',
      heroTitle: '监狱体验单',
      heroSubtitle: '果壳电竞',
      experienceMeta: {
        mapKey: 'prison_trial',
...
价格与累计：128r，双护累计 588 万。
    ...
    // --- 护航单：正式（2 条 product）---
    {
      ...
      tags: ['护航单', '正式护航', '保底'],
      image: '/images/rules/order-09.webp',
      heroImage: '/images/rules/order-09.webp',
      heroTitle: '正式护航',
      heroSubtitle: '果壳电竞',
      escortMeta: {
        variant: 'formal',
...
具体结算与炸单规则见「点单说明」或客服确认。
    ...
    },
    {
      ...
      tags: ['护航单', '监狱', '保底'],
      image: '/images/rules/order-10.webp',
      heroImage: '/images/rules/order-10.webp',
      heroTitle: '监狱护航',
      heroSubtitle: '果壳电竞',
      escortMeta: {
        variant: 'prison',
...
各档位（人民币 / 保底带出，单位：万）：
  ...
  388r → 保底 1888 万
    ...
    playmateMapProduct('playmate-juemi-jianyu', '绝密监狱', PLAYMATE_TIERS_JUEMI_JIANYU, 7, 85),
    {
      ...
      tags: ['陪玩单', '女陪', '娱乐'],
      image: '/images/rules/order-07.webp',
      heroImage: '/images/rules/order-07.webp',
      heroTitle: '女陪',
      heroSubtitle: '果壳电竞',
...
10. 下班回家
    ...
    },
    {
      ...
      tags: ['趣味单', 'AI改枪', '豆包'],
      image: '/images/rules/order-11.webp',
      heroImage: '/images/rules/order-11.webp',
      heroTitle: 'AI改枪单',
      heroSubtitle: '果壳电竞',
...
打手必须使用豆包随机给出的两把枪及其改枪码完成本单。
    ...
    },
    {
      ...
      tags: ['趣味单', '魔王连连撤', '连撤'],
      image: '/images/rules/order-06.webp',
      heroImage: '/images/rules/order-06.webp',
      heroTitle: '魔王连连撤',
      heroSubtitle: '果壳电竞',
...
· 撤离成功时，沙色保险才计数；房卡开了即计数。
    ...
    },
    {
      ...
      tags: ['趣味单', '沙保连连看', '多档位'],
      image: '/images/rules/order-05.webp',
      heroImage: '/images/rules/order-05.webp',
      heroTitle: '沙保连连看',
      heroSubtitle: '果壳电竞',
...
· 撤离成功且带出物资价值大于 400 万时，沙色保险才计数；房卡开了即计数。
    ...
    },
    {
      ...
      image: '/images/rules/order-04.webp',
      heroImage: '/images/rules/order-04.webp',
      heroTitle: '回家的诱惑',
      heroSubtitle: '果壳电竞',
...
注：若因老板原因未成功撤离，按结单处理。最终解释权归果壳电竞所有。
    ...
    // 恋爱日记：正文「癫子」为口述原文，疑为「垫子」等业务谐音，请按需替换文案
    {
      ...
      tags: ['趣味单', '恋爱日记', '双档位'],
      image: '/images/rules/order-08.webp',
      heroImage: '/images/rules/order-08.webp',
      heroTitle: '恋爱日记',
      heroSubtitle: '果壳电竞',
