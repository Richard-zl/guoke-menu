...
/**
 * ---------------------------------------------------------------------------
 * 重要：本脚本生成的是「暗色渐变 + 底部两行文字」，不是卡通/插画封面。
 * 卡通、二次元战术图请用外部 AI 出 PNG，再执行 import-ai-covers（见 package.json）。
 * 需要导出文件名清单时：npm run list:ai-covers
 * ---------------------------------------------------------------------------
 *
...
const COVERS = [
  ...
  ['fun-full-load-basic-488', '#3a2040', '#6a3555', '趣味单', '满载而归·基础'],
  ['fun-full-load-advanced-688', '#2a1838', '#5a3060', '趣味单', '满载而归·进阶'],
  ['fun-space-ring-tour-1288', '#1a2a4a', '#2d5080', '趣味单', '环游航天城'],
  ['fun-unspoken-secret-688', '#3a2048', '#604090', '趣味单', '不能说的秘密'],
  ['fun-golden-ammo-supplier-688', '#3a3018', '#6a5028', '趣味单', '进货商'],
  ['fun-raven-express-488', '#1a2838', '#2d4868', '趣味单', '渡鸦快递箱'],
  ['fun-shawshank-escape-688', '#2a1a1a', '#5a3030', '趣味单', '肖生克的救赎'],
  ['fun-self-reliance-juemi-328', '#1a3a2a', '#2d6a45', '趣味单', '自力更生'],
  ['fun-shield-heal-double-388', '#1a3048', '#2d5088', '趣味单', '盾盾奶·双护'],
  ['fun-shield-heal-single-388', '#1a2840', '#2d4880', '趣味单', '盾盾奶·单护'],
  ['fun-brave-certificate-phase1', '#2a2048', '#4a3088', '趣味单', '勇者之证·一阶'],
  ['fun-brave-certificate-phase2', '#3a2040', '#6a4080', '趣味单', '炫彩勇者之证'],
